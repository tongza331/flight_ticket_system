 ...
 */
 export default class QuantityInput {
    constructor(self, decreaseText, increaseText) {
      ...
      // Button constructor
      function Button3(text, className){
        this.button = document.createElement('button3');
        this.button.type = 'button3';
      ...
      // Create buttons
      this.subtract = new Button3(this.decreaseText, 'sub');
      this.add = new Button3(this.increaseText, 'add');
